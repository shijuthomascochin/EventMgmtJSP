          ...
          <tr>
            <td align="left" valign="top"><p><br>
              ...
              <table width="462" border="1">
                ...
                <tr bgcolor="#BF2B1F">
                  <td width="94" height="16"><div align="center" class="style6">
                      <div align="center">Event</div>
                  </div></td>
                  <td width="115"><div align="center" class="style6">
                      <div align="center">Stage</div>
                  </div></td>
                  <td width="83"><div align="center" class="style6">
                      <div align="center">Date</div>
                  </div></td>
                  <td width="61"><div align="center" class="style6">
                      <div align="center">Time</div>
                  </div></td>
                  <td width="75"><div align="center" class="style6">
                      <div align="center">Duration</div>
                  </div></td>
                </tr>
                <%
		  rs=obj.select("SELECT Events.event_name, EventSchedule.stage_name, CONVERT (varchar,EventSchedule.event_date,101) as event_date,EventSchedule.event_stime, EventSchedule.event_duration FROM EventSchedule INNER JOIN Events ON EventSchedule.event_id = Events.event_id ORDER BY Events.event_name");
		  while(rs.next())
		  {
		  %>
                <tr class="mm">
                  <td height="24"><div align="center" class="style7"><%=rs.getString(1)%></div></td>
