  ...
  <tbody>
    <tr>
	 ...
	 <table width="662" height="48" border="1">
           			 <tr bgcolor="#BF2B1F">
            	  <td height="20" colspan="2"><div align="center" class="style4">Arts Rules</div></td>
              </tr>
			   <%
			   int i =0;
            ...
            <tr bgcolor="#BF2B1F">
			  ...
			  %>
			    ...
			    <p>&nbsp;</p>
			    <p>
			      <input name="Button2" type="button" class="btn" value="Home" onClick='location.href="artsadminpage.jsp"' >
			    </p></td>
    </tr>
  </tbody>
</table>
