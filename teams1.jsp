      ...
      <td align="center" valign="top" class="subtitle"><p class="title">&nbsp;</p>
        ...
        <table width="522" border="1">
          ...
          <tr bgcolor="#BF2B1F">
            ...
            <td width="135"><div align="center" class="style6">
          ...
          <tr class="mm">
            ...
            <td>
                      ...
                      <div align="center">
                        <input name="Button" type="button" class="btn1" onClick='var s = confirm("Are you sure?"); if(s) location.href="teams1.jsp?tm=<%=str%>" ' value="Delete">
                    </div></td>
          </tr>
          <%}%>
        </table>		
		  <p>
		    <input name="Button2" type="button" class="btn" value="Add new team" onClick='location.href="addnewteam.jsp"' >
		  </p></td>
    </tr>
  </tbody>
</table>
