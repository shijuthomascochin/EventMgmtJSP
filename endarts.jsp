      ...
      <td align="center" valign="top"><p class="title">&nbsp;</p>
        ...
        <p align="center" class="style10">
          <%
				...
				try
				{
					obj.idu("DELETE FROM [EventParticipants]");
					obj.idu("DELETE FROM [EventResults]");
					obj.idu("DELETE FROM [EventSchedule]");
					obj.idu("DELETE FROM [MainResult]");
					obj.idu("DELETE FROM [Participant]");
					obj.idu("DELETE FROM [Register]");
					obj.idu("DELETE FROM [Sponsors]");
					obj.idu("DELETE FROM [Participant]");
					obj.idu("DELETE FROM [Teams]");
					out.print("Arts have been successfully ended");
				}
				catch(Exception ex)
				{
					out.print(ex);
        ...
        <p align="center" class="title">&nbsp;</p></td>
    </tr> 
  </tbody>
</table>
</td> 
