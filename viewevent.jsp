        ...
        <tbody>
          <tr>
            <td align="left" valign="top"><p><br>
              ...
              <p>&nbsp;</p>
              <table width="700" height="82" border="1">
                    <tr bgcolor="#BF2B1F">
                    ...
                    <tr bgcolor="#BF2B1F">
                      ...
                      <td width="110"><div align="center"><span class="style6">Event Name </span></div></td>
                      <td width="61"><div align="center"><span class="style6">Type </span></div></td>
                      ...
                      <td width="78"><div align="center"><span class="style6">Point 3 </span></div></td>
                      <td width="76"><div align="center"><span class="style6">Max ppl </span></div></td>
                    </tr>
                    <%
		  ...
		  %>
                    <tr class="mm">
                      <td height="28"><div align="center" class="style7"><%=str%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(2)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(3)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(4)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(5)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(6)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(7)%></div></td>
                      <td height="28"><div align="center" class="style7"><%=rs.getString(8)%></div></td>
                    </tr>
                    <%}%>
                  </table>
                  <p align="center">&nbsp;                    </p>
                  <p align="center">
                    <input name="Submit3" type="button" class="btn" value="Event rules" onClick='location.href="evnt_rules2.jsp"' >
                    <input name="Submit32" type="button" class="btn" value="Arts rules" onClick='location.href="artsrules2.jsp"' >
                  </p>
                  <p align="justify">
