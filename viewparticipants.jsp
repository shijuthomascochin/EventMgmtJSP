        ...
        <tbody>
          <tr>
            <td align="left" valign="top"><p><br>
              ...
              <p>&nbsp;</p>
              <table width="671" height="77" border="1">
                <tr bgcolor="#BF2B1F">
                  <td height="20" colspan="5"><div align="center" class="style4">Participants Details </div></td>
                </tr>
                <tr bgcolor="#BF2B1F">
                  <td width="77" height="23"><div align="center" class="style6">
                      <div align="center">Chest No: </div>
                  </div></td>
                  <td width="108"><div align="center" class="style6">
                      <div align="center">Name</div>
                  </div></td>
                  <td width="168"><div align="center" class="style6">
                      <div align="center">Team</div>
                  </div></td>
                  <td width="203"><div align="center" class="style6">College</div></td>
                  <td width="81"><div align="center" class="style6">Sex</div></td>
                  </tr>
                <%
		  ...
		  %>
              ...
              <p align="center">&nbsp;</p>
                  <p align="center">
                    <input name="Button22" type="button" class="btn" value="Participants and Events" onClick='location.href="part_events2.jsp"' >
                  </p>
                  <p align="justify">
