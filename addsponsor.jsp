  ...
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" class="subtitle"><p class="title">&nbsp;</p>
        ...
        <form name="form1" method="post" action="addsponsor.jsp" onSubmit='return formValidator()' >
          <table width="412" height="153" border="1">
            <tr bgcolor="#BF2B1F">
            ...
            <tr class="mm">
              ...
              <td><div align="left">
                <textarea name="t3" cols="20" rows="3" id="t3"></textarea>
              </div>                </td>
            </tr>
            <tr class="mm">
		...
		if(spnam!=null)
		{
        	try
        	{
                	rs = obj.select("SELECT 'sp'+CONVERT(varchar, ISNULL(MAX(CONVERT(int, SUBSTRING(sp_id, 3, LEN(sp_id))) + 1), 1)) AS Head FROM Sponsors WHERE (SUBSTRING(sp_id, 1, 2) = 'sp')");
                	if(rs.next())
                	{
						spid=rs.getString(1);
               		}
					obj.idu("INSERT INTO Sponsors VALUES('"+spid+"','"+spnam+"','"+spamt+"','"+spdec+"')");
					out.println("New sponsor has been successfully added");
					out.println("<br><br>");
					out.println("Sponsor id: "+spid);
        	}
        	catch (Exception ex)
        	{
           		out.println(ex);
