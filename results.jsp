    ...
    <tr>
      ...
      <td align="center" valign="top" class="subtitle"><p class="title">&nbsp;</p>
		...
		<table width="413" height="76" border="1">
          ...
          <tr bgcolor="#BF2B1F">
		     <td width="42" height="16"><div align="center"><span class="style6">&nbsp;</span></div></td>
            <td width="138" height="16"><div align="center"><span class="style6">Team</span></div></td>
            <td width="153"><div align="center"><span class="style6">College</span></div></td>
		  ...
		  <p>
		    <label>
		    <input name="Submit" type="button" class="btn" value="Event results" onClick='document.location.href="eventresults.jsp"'  >
		    </label>
		  </p>
		  <p><table width="413" height="52" border="1">
            <tr bgcolor="#BF2B1F">
              <td height="20" colspan="4" class="smalltitle"> <div align="left" class="style8">
                <div align="center" class="smalltitle">Kalathilakam</div>
             </td>
			 <%
				String cout="";
				int ii=0;
