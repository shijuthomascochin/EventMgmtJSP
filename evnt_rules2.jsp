...
%>
      ...
      <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="15" width="679">
        <tbody>
          <tr>
            <td width="517" align="left" valign="top"><p><br>
              ...
              <p>&nbsp;</p>
              <form name="form1" method="get" action="evnt_rules2.jsp" >
          <table width="500" height="63" border="1" align="center">
            <tr bgcolor="#BF2B1F">
              <td height="27" colspan="2"><div align="center" class="style4">Event Rules </div></td>
            </tr>
            <tr class="mm">
              <td width="179" height="28"><div align="center" class="style7">
         ...
         <%  
			   ...
			   %>
			    ...
			    <table width="500" height="48" border="1" align="center">
           			 <tr bgcolor="#BF2B1F">
            ...
            <tr bgcolor="#BF2B1F">
			  ...
			  %>
			    ...
			    <p align="center">
			      <input name="Button" type="button" class="btn" value="Back" onClick='location.href="viewevent.jsp"' >
			      <br>
			      <br>
		        </p>
			    <p>&nbsp;</p>
