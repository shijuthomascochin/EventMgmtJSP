  ...
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" class="subtitle"><p class="title">&nbsp;</p>
		...
		<table width="461" height="76" border="1">
          <tr bgcolor="#BF2B1F">
		  ...
		  <p>&nbsp;</p>
		  <p>
		    <input name="Button" type="button" class="btn" value="Home" onClick='location.href="adminpage.jsp"' > &nbsp;&nbsp;&nbsp;
            <input name="Button2" type="button" class="btn" value="Back" onClick='location.href="results.jsp"' >
		  </p></td>
    </tr>
  </tbody>
</table>
