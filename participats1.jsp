      ...
      <td align="center" valign="top" class="subtitle"><p class="title">&nbsp;</p>
        ...
        <table width="671" border="1">
          ...
          <tr bgcolor="#BF2B1F">
            ...
            <td width="60"><div align="center" class="style8">Sex</div></td>
            <td width="71"><div align="center"><span class="style7"><span class="style8"><span class="style9"><span class="style9"><span class="style8"><span class="style8"></span></span></span></span></span></span></div></td>
          </tr>
          <%
          ...
          <tr class="mm">
            ...
            <td>
                      ...
                      <div align="center" class="style7">
                        <input name="Button" type="button" class="btn1" onClick='var s = confirm("Are you sure?"); if(s) location.href="participats1.jsp?tm=<%=str%>" ' value="Delete">
                    </div></td>
          </tr>
          <%}%>
        </table>		
